...
COPY --from=ai-builder /app/ai-engine/node_modules ./ai-engine/node_modules
...
COPY --from=queue-builder /app/queue-service/node_modules ./queue-service/node_modules
